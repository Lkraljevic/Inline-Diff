...
$__System.registerDynamic("b", ["9", "c", "d", "e"], true, function($__require, exports, module) {
  ...
  (function(mod) {
    if (typeof exports == "object" && typeof module == "object")
      mod($__require('9'), $__require('c'), $__require('d'), $__require('e'));
    else if (typeof define == "function" && define.amd)
...
$__System.registerDynamic("c", ["9"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("d", ["9"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("19", ["9", "18"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("1a", ["9"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("1b", ["9"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("9", ["1c"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("1d", ["9"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("20", ["1f"], true, function($__require, exports, module) {
  ...
  var global = this;
  var GLOBAL = this;
  module.exports = $__System._nodeRequire ? process : $__require('1f');
  return module.exports;
});

$__System.registerDynamic("1c", ["20"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.register('1', ['5', '6', '7', '8', '19', '22', '23', 'a', 'b', 'c', 'd', 'e', '1a', '1b', '1d'], function (_export) {
  var _createClass, _classCallCheck, CodeMirror, DiffMatchPatch, dmp, Pos, Editor, editor, inlineDiff;
  ...
  return {
    setters: [function (_) {
      ...
      CodeMirror = _4['default'];
    }, function (_5) {}, function (_6) {
      DiffMatchPatch = _6['default'];
    }, function (_7) {}, function (_a) {}, function (_b) {}, function (_c) {}, function (_d) {}, function (_e) {}, function (_a2) {}, function (_b2) {}, function (_d2) {}],
    execute: function () {
      'use strict';
      ...
      Editor = (function () {
        ...
        _createClass(Editor, [{
          ...
          */
          ...
          key: 'display',
          value: function display(text, diff) {
          ...
          */
          ...
          key: 'markUpDiff',
          value: function markUpDiff(diff) {
            ...
            for (var i = 0; i < diff.length; ++i) {
              ...
              if (tp == DIFF_EQUAL) {
                 ...
                 */
                if (i == 0) {
                  if (currenClean.end - currenClean.start > 3) currenClean.end -= 2;
                ...
                if (diff.length != 1) collapseSingle(editor.cm, currenClean.start, currenClean.end);
                ...
                for (var j = startLine; j < endLine; j++) {
                  ...
                  var marked = editor.cm.addLineClass(j, 'background', tp == DIFF_INSERT ? 'cm-insert' : 'cm-delete');
                  var markedGutter = editor.cm.addLineClass(j, 'gutter', tp == DIFF_INSERT ? 'cm-insert' : 'cm-delete');
      ...
      */
      ...
      inlineDiff = (function () {
        ...
        function inlineDiff(place, options) {
          _classCallCheck(this, inlineDiff);
          ...
          if (options) {
            if (options.baseText && options.newText) this.setTexts(options.baseText, options.newText);
          }
        }
        ...
        _createClass(inlineDiff, [{
          ...
          */
          ...
          key: 'setTexts',
          value: function setTexts(baseText, newText) {
          ...
          */
          ...
          key: 'diff_lineMode',
          value: function diff_lineMode(text1, text2) {
          ...
          */
          ...
          key: 'diffToString',
          value: function diffToString(diffs) {
            var html = [];
            for (var x = 0; x < diffs.length; x++) {
              html[x] = diffs[x][1];
            }
          ...
          value: function setMode(mode) {
            this.editor.cm.setOption('mode', mode);
          }
        }, {
          key: 'parentEl',
          set: function set(parentEl) {
            if (!parentEl) {
              return;
            }
            // If change parent
